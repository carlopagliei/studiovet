...
{	
	...
	public interface IReadOnlyConfigurationProvider : ICloneable
	{
		/// <summary>
	...
	/// <seealso cref="Profile" />
	public interface IConfigurationProvider : IReadOnlyConfigurationProvider
	{
		/// <summary>
		...
		IReadOnlyConfigurationProvider CloneReadOnly();
