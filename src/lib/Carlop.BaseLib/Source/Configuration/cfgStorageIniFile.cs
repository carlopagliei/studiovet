...
namespace Carlop.Configuration
{
	...
	public class IniFileCfgStorage : ConfigurationProviderBase
	{
		...
		public IniFileCfgStorage(string fileName) :
			base(fileName)
		{
		}
		...
		public IniFileCfgStorage(IniFileCfgStorage ini) :
			base(ini)
		{
		}
		...
		{
			return new IniFileCfgStorage(this);
		}
