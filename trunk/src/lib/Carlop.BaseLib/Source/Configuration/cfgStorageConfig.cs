...
namespace Carlop.Configuration
{
	...
	///   </code>
	///   </remarks>
	public class AppConfigCfgStorage : XmlBasedCfgStorage
	{
		// Fields
		...
		public AppConfigCfgStorage(string fileName) :
			base(fileName)
		{
		}
		...
		public AppConfigCfgStorage(AppConfigCfgStorage config) :
			base(config)
		{
		...
		{
			return new AppConfigCfgStorage(this);
		}
		...
		public string GroupName
		{
			...
			{ 
				...
				if (!RaiseChangeEvent(true, ConfigurationChangeType.Other, null, "GroupName", value))
					return;
				...
				RaiseChangeEvent(false, ConfigurationChangeType.Other, null, "GroupName", value);				
			}
		}
